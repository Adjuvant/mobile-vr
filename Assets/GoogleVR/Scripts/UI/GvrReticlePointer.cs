...
public class GvrReticlePointer : GvrBasePointer
{
	...
	public override void OnPointerEnter (RaycastResult raycastResultResult, bool isInteractive)
	{
		...
		// TD: Use layers so that "Ignore Raycast" does not act as trigger object.	
		if (raycastResultResult.gameObject.layer != 2) {
			// TD: Set the object using the data contained in event system (RaycastResult)
			gazedAt = raycastResultResult.gameObject;
			// TD: Set the time to now.
	...
	public override void OnPointerExit (GameObject previousObject)
	{
		...
		// TD: Reset reticle incase its still redish
		ResetGazeTimer();
	}
